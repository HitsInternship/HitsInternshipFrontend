...
export const updateStreamStatus = async (
  ...
  await api.put('/streams/edit', { id, status });
};

export const deleteStream = async (streamId: string): Promise<void> => {
  await api.delete('/streams/delete', { data: { streamId } });
};
